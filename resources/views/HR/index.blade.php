            ...
            @forelse($hrs as $hr)
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <small class="text-muted">{{ $hr->jabatan }}</small><br>
                    ...
                    <div>
                        ...
                        <a href="{{ route('hr.show', $hr->id) }}" class="btn btn-info btn-sm me-1">
                            <i class="bi bi-eye"></i> Detail
                        </a>
                        <a href="{{ route('hr.confirmDelete', $hr->id) }}" class="btn btn-danger btn-sm">
